...
import { Grid3X3, ZoomIn, ZoomOut, Maximize2, Package, Check } from 'lucide-react';
...
export default function FurnitureToolbar({
  gridVisible,
  onToggleGrid,
  zoom,
  onZoomIn,
    ...
    <div className="w-16 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-2 space-y-2">
        <div className="w-12 h-12 rounded-lg bg-[#0A5B91]/10 flex items-center justify-center">
          <Package size={20} className="text-[#0A5B91]" />
        </div>
      </div>
